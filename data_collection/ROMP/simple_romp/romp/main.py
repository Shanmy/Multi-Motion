...
def romp_settings(input_args=sys.argv[1:]):
    ...
    parser.add_argument('--smpl_path', type=str, default='/home/notebook/data/group/pose_caption_dataset/ROMP_and_BEV/smpl_packed_info.pth', help = 'The path of smpl model file')
    parser.add_argument('--model_path', type=str, default='/home/notebook/data/group/pose_caption_dataset/ROMP_and_BEV/ROMP.pkl', help = 'The path of ROMP checkpoint')
