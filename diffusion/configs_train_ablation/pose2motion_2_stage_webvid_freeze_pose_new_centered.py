config = dict(
    # exp args
    out_dir="/nfs/USRCSEA/IVA/Experiments/motion-diffusion/mitch-v3/pose2motion-ablation-v1",
    ...
    dataset=dict(
        data_type='joint',
        data_split=(0.2, 0.3, 0.3, 0.1, 0.1),
        ...
        pose_trans_aug_rad=(1.25, 1.25, 0.0),
    ),
    eval_dataset=dict(
    ...
    model=dict(
        ...
        pose_model_ckpt='/nfs/USRCSEA/IVA/Experiments/motion-diffusion/mitch-v3/multi-pose-v1/multi_pose_all_8_gpu/24-03-05-11-17-36/checkpoints/ema_0.9999_230000.pt',
    ),
