config = dict(
    ...
    log_interval=100,
    save_interval=5000,
    resume_checkpoint="/nfs/USRCSEA/IVA/Experiments/motion-diffusion/mitch-v3/pose2motion-ablation-v1/pose2motion_2_stage_webvid_8_gpu/24-02-29-07-46-56/checkpoints/model200000.pt",
