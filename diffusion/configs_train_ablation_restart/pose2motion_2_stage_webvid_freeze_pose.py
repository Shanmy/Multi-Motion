config = dict(
    ...
    log_interval=100,
    save_interval=5000,
    resume_checkpoint="/nfs/USRCSEA/IVA/Experiments/motion-diffusion/mitch-v3/pose2motion-ablation-v1/pose2motion_2_stage_webvid_freeze_pose_8_gpu/24-02-29-07-48-23/checkpoints/model220000.pt",

    dataset=dict(
        data_type='joint',
        data_split=(0.5, 0.15, 0.15, 0.1, 0.1),
