...
# maintain this code for validating MDM results


# copy code for dependencies

SMPL_DATA_PATH = "/nfs/USRCSEA/IVA/Models/PoseCaptionData/SMPL"
...
class MDM(nn.Module):
    def __init__(self, modeltype, njoints, nfeats, num_actions, translation, pose_rep, glob, glob_rot,
        ...
        self.njoints = njoints  # 263/251 for humanml/kit
        self.nfeats = nfeats  # smpl default 6, pre-processed 1
        self.num_actions = num_actions  # 1 for text
        self.data_rep = data_rep   # 'hml_vec' or 'rot6d'
        self.dataset = dataset   # 'humanml' or 'kit'

        self.pose_rep = pose_rep  # 'rot6d'
        self.glob = glob  # True
        self.glob_rot = glob_rot  # True
        ...
        self.state_dims = [self.njoints, self.nfeats]
    ...
    def encode_text(self, raw_text):
        ...
        max_text_len = 20 if self.dataset in ['humanml', 'kit', 'amass'] else None  # Specific hardcoding for humanml dataset
