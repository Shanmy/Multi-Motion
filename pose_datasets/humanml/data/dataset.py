...
class HumanML3D(data.Dataset):
    def __init__(self, mode, datapath='/home/s9053168/code/motion-diffusion-model/dataset/humanml_opt.txt', split="train", **kwargs):
        self.mode = mode
        ...
        abs_base_path = f'.'
        pre_path = '/home/s9053168/code/multi-pose-diffusion'
        dataset_opt_path = pjoin(abs_base_path, datapath)
        device = None  # torch.device('cuda:4') # This param is not in use in this context
        opt = get_opt(dataset_opt_path, device)
        opt.meta_dir = pjoin(pre_path, opt.meta_dir)
        ...
        #self.split_file = "/home/s9053168/code/multi-pose-diffusion/diffusion-v2/data_loaders/humanml/data/dummy_training.txt"
        #print("Using dummy split file for verification!!")  # [REP]
        
        if mode == 'text_only':
            self.t2m_dataset = TextOnlyDataset(self.opt, self.mean, self.std, self.split_file)
        else:
            self.w_vectorizer = WordVectorizer(pjoin(pre_path, 'glove'), 'our_vab')
